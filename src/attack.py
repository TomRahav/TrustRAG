            ...
            for j in range(self.adv_per_query):
                ...
                for it_ in range(self.num_iter):
                    ...
                    if (candidate_scores > current_score).any():
                        ...
                        adv_passage_ids[:, token_to_flip] = candidates[
                            best_candidate_idx
                        ]
                    else:
                        continue

                adv_text = self.tokenizer.decode(
                    adv_passage_ids[0],
