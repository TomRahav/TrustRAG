...
def main():
                ...
                if args.attack_method != "pia":
                    ...
                    with torch.no_grad():
                        ...
                        for j in range(len(adv_text_list)):
                            ...
                            )  # the length of topk_results is args.top_k + len(adv_text_list)
                    topk_results = sorted(
                    ...
                    topk_contents = [
                        topk_results[j]["context"] for j in range(args.top_k - 1)
                    ]
    ...
    total_topk_num = (
        len(target_queries_idx) * args.top_k * args.repeat_times
    )  # total number of topk contents
